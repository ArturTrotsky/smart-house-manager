                    ...
                    <div class="col-md-12">
                        <div class="card card-primary">
                            <div class="card-header">
                                <h3 class="card-title"><b>Edit scheduler</b></h3>
                            </div>
                            <form method="POST" action="{{ route('schedulers.update', $scheduler->id) }}">
                                @csrf

                                <input type="hidden" name="module_id" value="{{ $scheduler->module_id }}">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="module_name"
                                                       value="{{ $scheduler->modules->type->name }}"
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="value"
                                                       value="{{ old('value') ?? $scheduler->value }}"
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="unit"
                                                       value="{{ $scheduler->modules->type->unit }}"
                                                       class="form-control" id="object-name" disabled>
                                            </div>
                                        </div>
                                    </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group date" id="timepicker_on"
                                                        ...
                                                        <input type="text" name="on_time"
                                                               value="{{ old('on_time') ?? $scheduler->on_time }}"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group date" id="timepicker_off"
                                                        ...
                                                        <input type="text" name="off_time"
                                                               value="{{ old('off_time') ?? $scheduler->off_time }}"
                                ...
                                <div class="card-footer">
                                    <div class="row">
                                        <div class="col-md-auto">
                                            <a href="{{ route('modules.show', $scheduler->module_id) }}"
